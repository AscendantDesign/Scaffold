...
namespace Scaffold
{
	...
	public class ScaffoldUtil
	{
		...
		///// </summary>
		///// <param name="sockets">
		///// Reference to a list of sockets to inspect.
		///// </param>
		///// <param name="node">
		///// Reference to the node to find in the connections list.
		///// </param>
		///// <returns>
		///// True if there are one or more references to the specified node in the
		///// sockets connections lists.
		///// </returns>
		...
		////*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*
		///// <summary>
		///// Return a value indicating whether node 1 connects to node 2.
		///// </summary>
		///// <param name="node1">
		///// Reference to the first node to test.
		///// </param>
		///// <param name="node2">
		///// Reference to the second node to test.
		///// </param>
		///// <returns>
		///// True if an output socket on node 1 connects to an input socket
		///// on node 2. Otherwise, false.
		///// </returns>
		...
		//		}
		//		property.Value = ResourceMain.Audio32;
		//	}
		//}
		////*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*
		///// <summary>
		...
		///// </param>
		///// <param name="relativeFilename">
		///// Relative filename of the image to load.
		///// </param>
		///// <param name="embed">
		///// Value indicating whether the data will be embedded into the resource.
		///// </param>
		///// <param name="resources">
		...
		//			node.Properties.Add(property);
		//		}
		//		property.Value = ResourceMain.Link32;
		//	}
		//}
		////*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*
		///// <summary>
		...
		///// </param>
		///// <param name="relativeFilename">
		///// Relative filename of the video to load.
		///// </param>
		///// <param name="embed">
		///// Value indicating whether the data will be embedded into the resource.
		///// </param>
		...
		//			match = Regex.Match(ticket, ResourceMain.rxIsGUID);
		//			if(match.Success)
		//			{
		//				result =
		...
		//						break;
		//					case "MediaImage":
		//						resource = NodeFileObject.Resources.FirstOrDefault(x =>
